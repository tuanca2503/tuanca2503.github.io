                    ...
                    function() {
                        ...
                        t._filterArgs = [], r.interpolate = function(e, n, i, o) {
                            var s = r.shallowCopy({}, e),
                                a = r.composeEasingObject(e, o || "linear");
                            t.set({});
                            var u = t._filterArgs;
                    ...
                    function(t) {
                        ...
                        function c(t, e, n) {
                            var r = e.match(t),
                                i = e.replace(t, a);
                            if (r)
                                for (var o, s = r.length, u = 0; u < s; u++) o = r.shift(), i = i.replace(a, n(o));
                            return i
                        }
...
function(t) {
    ...
    t.event.special.inview = {
        add: function(n) {
            o.push({
                ...
                $element: t(this),
                element: this
            }), !i && o.length && (i = setInterval(e, 250))
        },
        remove: function(t) {
    ...
    Array.prototype.forEach.call(t, function(e, n) {
        ...
        new ProgressBar.Circle(t[n], {
            ...
            finish: function(t,e) {
                t._path.style.strokeDashoffset = 200
                e._path.style.strokeDasharray = 200
                e._path.style.strokeDashoffset = 200
            }
        })
